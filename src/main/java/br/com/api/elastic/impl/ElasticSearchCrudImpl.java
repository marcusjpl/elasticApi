...
import br.com.api.elastic.config.ElasticSearchClientConfig;
...
public class ElasticSearchCrudImpl implements ElasticSearchCrud {
	...
	private ElasticSearchClientConfig elasticSearchConfigClient = null;
	private RestHighLevelClient restClient = null;

	public ElasticSearchCrudImpl() {
		elasticSearchConfigClient = new ElasticSearchClientConfig();
		this.restClient = elasticSearchConfigClient.getInstance();
	}

	@Override
	public String obterDebitoUsuario(String codigo) {
		try {
            GetRequest request = new GetRequest("sgi", "debitousuario", codigo);
